...
data_dir = 'data'
sub_dir = data_dir+'/season_adv'
if not os.path.exists(data_dir):
    os.mkdir(data_dir)
if not os.path.exists(sub_dir):
    os.mkdir(sub_dir)
filename = sub_dir+'/'+str(start)+'_to_'+str(end)+'_season_adv.csv'
...
for year in range(int(start),int(end)+1):
    ...
    page = requests.get('https://www.sports-reference.com/cbb/seasons/'+str(year)+'-advanced-school-stats.html')
